/**
 * Created by sonth on 28/07/2016.
 */
...
var SocketInstance = (function () {
    var instance;

    function createInstance() {
        var csocket = io.connect(window.location.protocol + '//' + window.location.hostname + ':' + 3111);
        csocket.on('connect', function(s){
            csocket.emit('user-connect', {code: 1});
            csocket.emit('vt', {msg: 1});
        });
    }
